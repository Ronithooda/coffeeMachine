...
#  Report function in coffee machine
            self.resource["water"] -= self.menu[data]["ingredients"]["water"]
            self.resource["milk"] -=  self.menu[data]["ingredients"]["milk"] 
            self.resource["coffee"] -=  self.menu[data]["ingredients"]["coffee"]  
